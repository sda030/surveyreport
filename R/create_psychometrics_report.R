...
## Versjon 0.3
# Endre filnavnet
# argument: Velge hvilke funksjoner som skal kjøres
# argument: Velge hvilke IRT-modeller som skal kjøres (1PL, 2PL, etc)
# funksjon: Trekke ut Wright-map plot som egen funksjon (plot_1a)
# funksjon: Trekke ut ICC plots-loopen for TAM-data, som eegen funksjon
# funksjon: Trekke ut Mplus-modeller som egne funksjoner
# Generalisere mer (særlig grafer) og unngå hardkodede variabelnavn/labels
# Be Alexander Rorbitzh om å kunne endre navn på Plots-mappe
# argument: Endre argument defaults til engelsk/tom
# funksjon: Legge inn fortolkninger som tekst i fit (høy infit, etc). 
# funksjon: Item information curves (all in one graph)
