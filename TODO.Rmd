...
# Overall design
- add_barchart1, add_barchart1_caption, add_table1, add_table1_caption, etc. Allows user to specify order in reporter(). reporter will then basically just add whatever is available in a row.
