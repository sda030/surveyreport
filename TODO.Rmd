...
# report_chart_likert()
- sorting by sum of categories
- refactor sorting if-statements
- adjust to 0,20,40,60,80,100 on scale if figure is narrow
- hide small percentages (very hard!)
- Left adjustment seems impossible to fix in Word and mschart...
